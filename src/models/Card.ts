export interface Card {
  name: string;
  kind: 'Bonus300' | 'Bonus400' | 'Bonus500' | 'MustCut' | 'MustPass' | 'DoubleCheese' | 'NoCheese' | 'CheeseStrikesBack';
  bonus: number;
  description: string;
  quantity: number;
}
...
export const cards: Card[] = [
  ...
  { name: 'Must Cut', kind: 'MustCut', bonus: 0, description: 'You roll until you cut the cheese but take all the points you are able to take until you cut the cheese', quantity: 0 },
  { name: 'Must Pass', kind: 'MustPass', bonus: 1000, description: 'You must pass the cheese but you get a 1000 point bonus', quantity: 6 },
